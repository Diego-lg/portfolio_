        ...
        <div className="grid grid-cols-3 gap-4 sm:gap-6">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="bg-card p-2 sm:p-4 rounded-lg shadow-md border border-border flex flex-col items-center justify-center text-center"
            >
              <motion.div
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className={`text-4xl mb-2 ${skill.color} ${
                  skill.name === "Three.js" ? "h-[100px] w-[100px]" : ""
                }`}
              >
